          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Link href="/settings/email-templates" className="border rounded-lg p-4 hover:border-primary hover:bg-primary/5 transition-colors flex items-start gap-3">
                  <div className="p-2 rounded bg-warning/10 text-warning"><i className="bx bx-envelope-open text-2xl"></i></div>
                  <div className="flex-1">
                    <p className="font-semibold mb-1">Email Templates <span className="text-[0.65rem] font-medium px-1.5 py-0.5 rounded bg-danger/10 text-danger ml-1">SuperAdmin</span></p>
                    <p className="text-[0.75rem] text-[#8c9097]">Edit subject/body wording for OTP, order, approval, and other transactional emails.</p>
                  </div>
                  <i className="bx bx-chevron-right text-xl text-[#8c9097]"></i>
                </Link>
